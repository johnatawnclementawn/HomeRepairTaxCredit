...
nonEngineered <- housingSubsidy %>% dplyr::select(-starts_with("eng"))
...
GOF_ks <- createGOF(cvFit_ks, 'Kitchen sink model')
GOF_hnd <- createGOF(cvFit_hnd, 'Honed model')
